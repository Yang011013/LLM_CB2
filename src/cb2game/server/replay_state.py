...
from cb2game.server.card import Card, CardSelectAction
...
from cb2game.server.util import CountDownTimer, IdAssigner
...
class ReplayState(object):
    def __init__(
        ...
        self._game_record = game_record # game_db.Game
