...
from cb2game.server.messages.feedback_questions import FeedbackQuestion, QuestionType
from cb2game.server.messages.rooms import Role

LEADER_MOVES_PER_TURN = 5
FOLLOWER_MOVES_PER_TURN = 10

LEADER_SECONDS_PER_TURN = 60
FOLLOWER_SECONDS_PER_TURN = 3*60

FOLLOWER_TURN_END_DELAY_SECONDS = 0
