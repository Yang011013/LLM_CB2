...
import cb2game.server.actor as actor
import cb2game.server.messages.state_sync as state_sync
...
from cb2game.server.lobby_consts import LobbyInfo
from cb2game.server.map_tools.visualize import GameDisplay
from cb2game.server.messages import action as action_module
from cb2game.server.messages import message_from_server
from cb2game.server.messages.action import Action, ActionType
...
from cb2game.server.util import HEARTBEAT_TIMEOUT_S
...
class GameEndpoint(object):
    ...
    def step(self, action, wait_for_turn=True) -> GameState:
        ...
        message, reason = action.message_to_server(self.player_actor) # 在Server执行动作
